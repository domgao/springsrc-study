...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	 ...
	 * 将不考虑该 bean，即它不会被考虑作为其它 bean 自动装配的候选者，但是该 bean
	 ...
	 * <bean id="beanA", class="XXX.XXXBean" />
	 * <bean id="currentTime" factory-bean="beanA" factory-method="createTime" />
	 */
	@Nullable
	...
	/**
	 * 定义这个 bean 的应用，APPLICATION：用户，INFRASTRUCTURE：完全内部使用，与用户无关，
	 * SUPPORT：某些复杂配置的一部分
	 * 程序设置
	 */
